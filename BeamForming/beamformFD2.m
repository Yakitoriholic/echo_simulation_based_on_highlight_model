...
signal_padded_fft = fft(signal_padded, fft_len, 2);
...
element_signals_fft = (pve_B0).* signal_padded_fft;
element_signals = ifft(element_signals_fft, fft_len, 2, 'symmetric');
element_signals = element_signals(:,1:L);
...
save('FD2.mat', 't_total', 'beamformed_signals_time_domain');